Camel CXF JAX-WS CDI Java DSL Example
------------------------
...
The Camel context configuration is specified in a Java class.
...
Two CXF Interceptors are demonstrated, they are configured as part of the (Java) CXF Endpoint configuration.
