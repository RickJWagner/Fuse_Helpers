...
public class CustomComposer extends RESTEasyMessageComposer {
    ...
    public RESTEasyBindingData decompose(Exchange exchange, RESTEasyBindingData target) throws Exception {
        ...
        // Doesn't bring desired results, base class RESTEasyMessageComposer wants to return a 500
        //if (true) {
        //	exchange.getContext().setProperty(HTTP_RESPONSE_STATUS, 403).addLabels(new String[] { EndpointLabel.HTTP.label() });
        //}
