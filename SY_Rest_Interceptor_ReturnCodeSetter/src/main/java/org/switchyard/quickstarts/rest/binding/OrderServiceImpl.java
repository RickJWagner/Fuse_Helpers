...
public class OrderServiceImpl implements OrderService {
    ...
    public Order newOrder() {
    	System.out.println("### OrderServiceImpl::newOrder() fires ###");
        orderNo++;
    ...
    public Order getOrder(Integer orderId) throws Exception {
    	System.out.println("### OrderServiceImpl::getOrder() fires ###");
    ...
    public String addItems(Order order) throws Exception {
    	System.out.println("### OrderServiceImpl::addItems() fires ###");
